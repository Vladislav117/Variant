...
public class Variant {
    ...
    public Variant set(Object value) {
        ...
        if (value instanceof Short s) {
            type = VariantType.NUMBER;
            object = s.doubleValue();
            return this;
        }
        if (value instanceof Integer i) {
            type = VariantType.NUMBER;
            object = i.doubleValue();
            return this;
        }
        if (value instanceof Long l) {
            type = VariantType.NUMBER;
            object = l.doubleValue();
            return this;
        }
        ...
        if (value instanceof List<?> l) {
            ...
            object = new ArrayList<Variant>(l.size());
            for (Object innerObject : l) {
        ...
        if (value instanceof Map<?, ?> m) {
            ...
            object = new HashMap<String, Variant>(m.size());
    ...
    public Variant insert(int childIndex, Object value) {
        if (type != VariantType.LIST) throw new VariantTypeError(type, VariantType.LIST);
        if (childIndex < 0) {
            ((List<Variant>) object).addFirst(new Variant(value));
            return this;
        }
        if (childIndex >= ((List<?>) object).size()) {
            ((List<Variant>) object).addLast(new Variant(value));
            return this;
        }
