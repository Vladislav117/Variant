...
public class VariantClass extends Class {
    ...
    public static final class ComplexStatements {
        static ComplexStatement IF_NOT_LIST_THROW_ERROR = new ComplexStatement(Statements.IF_NOT_LIST_THROW_ERROR) {{
            setDocumentationLines(new ArrayList<>() {{
                add(Documentation.IF_NOT_LIST_THROW_DESCRIPTION);
            }});
            setThrowsDescriptions(new ArrayList<>() {{
    ...
    protected void createMethods() {
        ...
        addMethod(new Method("set") {{
            ...
            setCode(new StatementBasedCode() {{
                ...
                addIf("value instanceof Boolean b", new StatementBasedCode() {{
                    addStatement("type = VariantType.BOOLEAN");
                    addStatement("object = b");
                    addStatement(Statements.RETURN_THIS);
                }});
                addIf("value instanceof Byte b", new StatementBasedCode() {{
                    addStatement("type = VariantType.NUMBER");
                    addStatement("object = b.doubleValue()");
                    addStatement(Statements.RETURN_THIS);
                }});
                addIf("value instanceof Short s", new StatementBasedCode() {{
                    addStatement("type = VariantType.NUMBER");
                    addStatement("object = s.doubleValue()");
                    addStatement(Statements.RETURN_THIS);
                }});
                addIf("value instanceof Integer i", new StatementBasedCode() {{
                    addStatement("type = VariantType.NUMBER");
                    addStatement("object = i.doubleValue()");
                    addStatement(Statements.RETURN_THIS);
                }});
                addIf("value instanceof Long l", new StatementBasedCode() {{
                    addStatement("type = VariantType.NUMBER");
                    addStatement("object = l.doubleValue()");
                    addStatement(Statements.RETURN_THIS);
                }});
                addIf("value instanceof Float f", new StatementBasedCode() {{
                    addStatement("type = VariantType.NUMBER");
                    addStatement("object = f.doubleValue()");
                    addStatement(Statements.RETURN_THIS);
                }});
                addIf("value instanceof Double d", new StatementBasedCode() {{
                    addStatement("type = VariantType.NUMBER");
                    addStatement("object = d");
                    addStatement(Statements.RETURN_THIS);
                }});
                addIf("value instanceof Character c", new StatementBasedCode() {{
                    addStatement("type = VariantType.STRING");
                    addStatement("object = c.toString()");
                    addStatement(Statements.RETURN_THIS);
                }});
                addIf("value instanceof String s", new StatementBasedCode() {{
                    addStatement("type = VariantType.STRING");
                    addStatement("object = s");
                    addStatement(Statements.RETURN_THIS);
                }});
                addIf("value instanceof List<?> l", new StatementBasedCode() {{
                    addStatement("type = VariantType.LIST");
                    addStatement("object = new ArrayList<Variant>(l.size())");
                    addFor("Object innerObject : l", new StatementBasedCode() {{
                        addStatement("((List<Variant>) object).add(new Variant(innerObject))");
                    }});
                    addStatement(Statements.RETURN_THIS);
                }});
                addIf("value instanceof Map<?, ?> m", new StatementBasedCode() {{
                    addStatement("type = VariantType.MAP");
                    addStatement("object = new HashMap<String, Variant>(m.size())");
                    addFor("Map.Entry<?, ?> entry : m.entrySet()", new StatementBasedCode() {{
                        addStatement("((Map<String, Variant>) object).put(entry.getKey().toString(), new Variant(entry.getValue()))");
                    }});
                    addStatement(Statements.RETURN_THIS);
                }});
                addIf("value instanceof Variant v", new StatementBasedCode() {{
                    addStatement("set(v.object)");
                    addStatement(Statements.RETURN_THIS);
                }});
        ...
        addMethod(new Method("insert") {{
            ...
            setCode(new StatementBasedCode() {{
                ...
                addStatement(new IfStatement("childIndex < 0", new StatementBasedCode() {{
                    addStatement("((List<Variant>) object).addFirst(new Variant(value))");
                    addStatement(Statements.RETURN_THIS);
                }}));
                addStatement(new IfStatement("childIndex >= ((List<?>) object).size()", new StatementBasedCode() {{
                    addStatement("((List<Variant>) object).addLast(new Variant(value))");
                    addStatement(Statements.RETURN_THIS);
                }}));
        ...
        addMethod(new Method("equals") {{
            ...
            setCode(new StatementBasedCode() {{
                addSimpleIf("!(obj instanceof Variant other)", "return false");
